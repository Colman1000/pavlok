...
class _CircularSliderState extends State<CircularSliderPaint> {
  ...
  void _calculatePaintData() {
    ...
    if (widget.shouldCountLaps) {
      ...
      if (isSingleHandler) {
        _laps = _calculateLapsForSingleHandler(
    ...
    _painter = SliderPainter(
      ...
      handlerOuterRadius: widget.handlerOutterRadius,
      showRoundedCapInSelection: widget.showRoundedCapInSelection,
      showHandlerOuter: widget.showHandlerOutter,
      sliderStrokeWidth: widget.sliderStrokeWidth,
    );
  }

  int _calculateLapsForSingleHandler(
  ...
  void _handlePan(Offset details, bool isPanEnd) {
    ...
    if (isBothHandlersSelected) {
      var newValueInit =
          (newValue - (_differenceFromInitPoint ?? 0)) % widget.divisions;
